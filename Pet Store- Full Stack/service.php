...
<HTML>
    ...
    {
    echo "</p> oops....The entered email id already exists. Kindly use a new one to register./p>";
    exit();
    }
    else
    {
    ...
    echo "<p>Data recorded for the service successfully!</p>";
    } else {
    ...
    echo "<p>Data recorded for the user in login successfully!</p>";
    } else {
